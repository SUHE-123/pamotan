...
<head>
    ...
    <style>
        ...
        * {
        ...
        .wind-icon {
            color: #2196f3;
            animation: windMove 2s infinite ease-in-out;
        }
...
<body>
            ...
            <div class="card-body">
                <?php if ($total > 0): ?>
                    <div class="stats-info">
                        <p>
                            ...
                            Menampilkan <?= $total ?> data kecepatan angin untuk tanggal <?= $tanggal ?>
                        </p>
                    </div>
                        ...
                        <table class="compact-table">
                            ...
                            <tbody>
                                ...
                                while($row = $result->fetch_assoc()) {
                                    $windSpeed = round($row['kecepatan'], 2);
                                    echo "<tr>
                                        <td><strong>$no</strong></td>
                                        <td><span class='wind-value'>$windSpeed km/jam</span></td>
                ...
                <?php else: ?>
                    <div class="no-data">
                        ...
                        <p>Tidak ada data kecepatan angin untuk tanggal <?= $tanggal ?></p>
                    </div>
                <?php endif; ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Add wind effect to table rows on hover/touch
            const tableRows = document.querySelectorAll('.compact-table tbody tr');
            tableRows.forEach(row => {
                row.addEventListener('mouseenter', function() {
                    const windIcon = this.querySelector('.fa-wind');
                    if (windIcon) {
                        windIcon.style.animation = 'windMove 1s infinite ease-in-out';
                    }
                });
                ...
                row.addEventListener('mouseleave', function() {
                    const windIcon = this.querySelector('.fa-wind');
                    if (windIcon) {
                        windIcon.style.animation = 'windMove 2s infinite ease-in-out';
                    }
                });
            });
        });
