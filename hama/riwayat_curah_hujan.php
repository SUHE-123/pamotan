...
$total_result = $koneksi->query("SELECT COUNT(*) AS total FROM curah_hujan WHERE DATE(waktu) = '$tanggal'");
$total = $total_result->fetch_assoc()['total'];
$total_pages = ceil($total / $limit);

$sql = "SELECT * FROM curah_hujan WHERE DATE(waktu) = '$tanggal' ORDER BY waktu DESC LIMIT $limit OFFSET $offset";
...
<head>
    ...
    <title>Riwayat Curah Hujan</title>
    ...
    <div class="container">
        ...
        <div class="header">
            <div class="page-title">
                <h1><i class="fas fa-cloud-rain"></i> Riwayat Curah Hujan</h1>
            </div>
        ...
        <div class="sensor-card">
            <div class="card-header">
                <h2><i class="fas fa-tint"></i> Data Curah Hujan (<?= $tanggal ?>)</h2>
            </div>
            <div class="card-body">
                <?php if ($total > 0): ?>
                    <div class="stats-info">
                        <p>
                            ...
                            Menampilkan <?= $total ?> data curah hujan untuk tanggal <?= $tanggal ?>
                        </p>
                    </div>
                            ...
                            <tbody>
                                ...
                                while($row = $result->fetch_assoc()) {
                                    echo "<tr>
                                        ...
                                        <td><span class='data-value'>{$row['nilai']} mm</span></td>
                ...
                <?php else: ?>
                    <div class="no-data">
                        ...
                        <p>Tidak ada data curah hujan untuk tanggal <?= $tanggal ?></p>
                    </div>
                <?php endif; ?>
